package com.mycompany.a3telalogin;
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {   
         ...
         try {
            ...
            Connection connection = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/db_biblioteco", "root", "admin"
            );
            ...
            if(auth.next()){
                if(auth.getInt(5) == 1){
                    JOptionPane.showMessageDialog(null, "Bem vindo SUPER administrador!");
                } else if(auth.getInt(4) == 1){
